...
lore.ore.ui.narrativeResTemplate = new Ext.XTemplate(  
    ...
    '<div id="{uri}">',
        ...
        '<tpl if="representsCO == false && representsAnno == false"><p style="font-style:italic;padding-bottom:0.5em;"><a title="Show in browser" onclick="lore.global.util.launchTab(\'{uri}\')" href="#">{uri}</a></p></tpl>',
        '<tpl for="properties">{[this.displayProperties(values)]}</tpl>',
    '</div>',
    '</tpl>',
    {
